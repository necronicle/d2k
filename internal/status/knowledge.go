...
type Knowledge struct {
	...
	// ClientUnfit — сколько раз план НЕ ИСПОЛНИЛСЯ потоку настоящего клиента
	// постоянной причиной, пока он стоял на цели. Это не свойство коробки и
	// не промах кандидата: это наша непереносимость. Рядом с Confirms оно
	// стоит затем, что без него «подтверждено N» читается как «обход
	// работает» (лаборатория 13.09.2026, седьмая находка).
	ClientUnfit int `json:"client_unfit"`
}
